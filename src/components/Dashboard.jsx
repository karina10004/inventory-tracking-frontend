						...
						<ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
							...
							<Link to = '/inventory' style = {{ textDecoration: "none" }}>
								<li>
										...
										<i className="fs-4 bi-people"></i> <span className="ms-1 d-none d-sm-inline">View inventory</span>
								</li>
							</Link>
							<li>
							...
							<li>
									...
									<i className="fs-4 bi-plus-circle"></i> <span className="ms-1 d-none d-sm-inline">Addproducts</span>
							</li>
							</Link>
							<li>
